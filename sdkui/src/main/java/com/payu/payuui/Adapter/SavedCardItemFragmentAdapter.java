...
public class SavedCardItemFragmentAdapter extends FragmentStatePagerAdapter {
    ...
    private SavedCardItemFragment mSavedCardItemFragment;
    private HashMap<String, CardStatus> mValueAddedHashMap;
    private Bundle mBundle;
    private String bankStatus = "";
    private FragmentManager mFragmentManager;
    private HashMap<String, String> mOneClickCardTokens;
