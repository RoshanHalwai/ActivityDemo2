...
public class PaymentGateway extends AppCompatActivity {
    ...
    public void navigateToBaseActivity() {
        ...
        merchantKey = "0MQaQP";
        String amount = UserOrderSummary.strGrandTotal;
        String email = "payutest@payu.in";
    ...
    protected void onActivityResult(int requestCode, int resultCode, final Intent data) {
        if (resultCode == RESULT_OK) {
            boolean isCOD = Boolean.parseBoolean(data.getExtras().getString("CASH_ON_DELIVERY"));
            if (isCOD)
        ...
        if (requestCode == PayuConstants.PAYU_REQUEST_CODE) {
            if (data != null) {
                ...
                Intent intent = new Intent(getApplicationContext(), UserOrderSummary.class);
